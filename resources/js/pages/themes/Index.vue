        ...
        <div class="bg-white dark:bg-card overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 text-gray-900 dark:text-white">
            <div class="flex items-center justify-between mb-6">
              <h1 class="text-2xl font-semibold text-primary">Themes</h1>
              <Link
              ...
              <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-800">
                  <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Descriptions</th>
                ...
                <tbody class="bg-white dark:bg-card divide-y divide-gray-200 dark:divide-gray-700">
                  <tr v-for="theme in themes.data" :key="theme.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">{{ theme.poster }}</td>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                      <div class="flex items-center justify-end space-x-2">
                        <Button
                          ...
                          @click="() => {router.visit(route('themes.show', theme.id))}"
                        >
                          View
                        </Button>
                        <Button
                        ...
                        <Dialog>
                          <DialogTrigger asChild>
                            <Button variant="destructive" class="cursor-pointer" @click="themeToDelete.value = theme">Delete</Button>
                          </DialogTrigger>
